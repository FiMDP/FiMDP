...
solver_class = lambda mdp, cap, t: EnergySolver_GoalLeaning(mdp, cap, t, threshold=0.1)
...
threshold = EnergySolver_GoalLeaning(m, cap=35, targets=t, threshold=0.1)
...
threshold = EnergySolver_GoalLeaning(two_step, targets=[3], threshold=0.011)
