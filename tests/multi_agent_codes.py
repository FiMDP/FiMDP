...
#Generate graph with costs
Agent_graph=generate_Graph(m,T,env)

#Number of agents to visit all targets, used for splitting
num_agent=5

#Compute minimum possible cost path for the given number of agents
compute_min_cost_bisection(Agent_graph,num_agent)
