...
result_pos = m.get_positiveReachability(targets, 10)
expected_pos = [2, 1, 2, inf]

result_as = m.get_almostSureReachability(targets, 10)
...
m.get_positiveReachability(targets, 22)
...
result = m.get_positiveReachability(targets, 20)
